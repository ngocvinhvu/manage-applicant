...
class ApplicantResource(Resource):
    ...
    def get(self, *args, **kwargs):
        ...
        if params['items_per_page'] and params['items_per_page'] < 1 and params['page'] and params['page'] < 1:
            abort(http_status_code.HTTP_406_NOT_ACCEPTABLE, "%s" % 'Parameters is invalid')
